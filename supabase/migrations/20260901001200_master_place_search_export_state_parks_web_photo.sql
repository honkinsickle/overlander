-- Add 'state_parks_web' to master_place_search_export's photo lateral.
--
-- Mirrors 20260901001100 (pois_along_corridor). Same priority 6 slot.
--
-- APPLY-PATH:
