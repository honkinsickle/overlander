-- Add 'state_parks_web_wa' to master_place_search_export's photo lateral.
--
-- Mirrors 20260901001400 (pois_along_corridor). Priority 7.
...
comment on view public.master_place_search_export is
  'Phase 2 Typesense sync source. photo_url from nps/ridb/wikipedia/atlas_oddities/family_destinations/editorial_food/state_parks_web/state_parks_web_wa via LEFT JOIN LATERAL, NPS preferred.';
