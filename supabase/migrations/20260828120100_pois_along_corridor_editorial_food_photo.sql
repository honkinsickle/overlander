-- ============================================================================
-- Add 'editorial_food' to pois_along_corridor's photo lateral.
--
-- Same shape as PR #316's 20260828110100 (which added family_destinations).
-- Chain becomes:
...
-- mapMasterPlaceRow in federated.ts. editorial_food photos live at
-- normalized_payload.photo.url (same shape as the other photo-carrying
-- sources), so no new coalesce path is needed.
--
