...
-- editorial_food.
--
-- Companion to 20260828120000/120100. Chain becomes:
--   nps > ridb > wikipedia > atlas_oddities > family_destinations >
--   editorial_food.
--
-- Same shape as PR #315's migration (which added wikipedia +
-- atlas_oddities) and PR #316's 20260828110200 (which added
-- family_destinations). CREATE OR REPLACE VIEW is legal because column
-- list and column order are unchanged. ADDITIVE for the doc pipeline —
-- search:sync must run after this lands so the photo_url field on the
-- Typesense docs reflects the widened source list.
--
-- TEST ONLY.
-- ============================================================================
